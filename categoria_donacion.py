...
def main():
    try:
        ...
        # Consulta SQL para seleccionar todos los registros de la tabla 'categoria_donacion'
        sql_query = "SELECT * FROM categoria_donacion;"
        ...
        print("Registros de la tabla 'categoria_donacion':")
        for row in records:
            print(row)
