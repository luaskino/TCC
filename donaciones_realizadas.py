...
def main():
    try:
        ...
        # Consulta SQL para seleccionar todos los registros de la tabla 'donaciones_realizadas'
        sql_query = "SELECT * FROM donaciones_realizadas;"
        ...
        print("Registros de la tabla 'donaciones_realizadas':")
        for row in records:
            print(row)
